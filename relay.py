...
# Set sense pin as input and pull down, only connect 3.3v to this pin
...
def main(window):
    ...
    # Print initial state
    window.addstr(middle_y - 1, middle_x - 7, "1", curses.color_pair(GPIO.input(pin1) + 1) + curses.A_BOLD)
    window.addstr(middle_y - 1, middle_x - 5, "2", curses.color_pair(GPIO.input(pin2) + 1) + curses.A_BOLD)
    window.addstr(middle_y - 1, middle_x - 3, "3", curses.color_pair(GPIO.input(pin3) + 1) + curses.A_BOLD)
    window.addstr(middle_y - 1, middle_x - 1, "4", curses.color_pair(GPIO.input(pin4) + 1) + curses.A_BOLD)
    window.addstr(middle_y - 1, middle_x + 1, "5", curses.color_pair(GPIO.input(pin5) + 1) + curses.A_BOLD)
    window.addstr(middle_y - 1, middle_x + 3, "6", curses.color_pair(GPIO.input(pin6) + 1) + curses.A_BOLD)
    window.addstr(middle_y - 1, middle_x + 5, "7", curses.color_pair(GPIO.input(pin7) + 1) + curses.A_BOLD)
    window.addstr(middle_y - 1, middle_x + 7, "8", curses.color_pair(GPIO.input(pin8) + 1) + curses.A_BOLD)
    window.addstr(middle_y + 1, middle_x - 2, "Power", curses.color_pair(GPIO.input(pin9) + 1) + curses.A_BOLD)
    ...
    try:
        ...
        while True:
            ...
            if GPIO.input(pin9):
                ...
                # Relays are not powered, turn off all outputs immediately
                if active_low == 1:
                    GPIO.output(pin1, GPIO.HIGH)
                    GPIO.output(pin2, GPIO.HIGH)
                    GPIO.output(pin3, GPIO.HIGH)
